!(function (t, e, i, n) {
    ...
    $(document).ready(function () { 
        ...
        function i(t, e, i) {
            $(".main-content").children().removeClass("section--is-active"),
                ...
                0 !== e ? $(".header--cta").addClass("is-active") : $(".header--cta").removeClass("is-active");
        }
        function n() {
        ...
        $(this).on("mousewheel DOMMouseScroll", function (e) {
            ...
            $(".cta").click(function () {
                var t = $(".side-nav").find(".is-active"),
                    ...
                    firstItem = 0;
                e(firstItem), i(n, firstItem, firstItem);
            });
            $(".cta1").click(function () {
                var t = $(".side-nav").find(".is-active"),
                    n = $(".side-nav").children().index(t),
    ...
    function setRating(rating) {
        ...
        ratingValue.textContent = rating; // Update the text displaying the rating
    ...
    function toggleTranslateDisplay(element) {
        var display = element.nextElementSibling;
        if (display.style.display === 'none') {
            document.querySelectorAll('.number-display').forEach(function(div) {
